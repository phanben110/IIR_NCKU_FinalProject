...
with st.sidebar:
    selected = option_menu("Main Menu", ["1. Data Processing", "2. BERT Training", "3. Evaluation", "4. Inference"],
                           icons=["blockquote-right","cpu-fill", "bar-chart-fill", "body-text" ], menu_icon="bars", default_index=0)
